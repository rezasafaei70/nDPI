...
//  NDPI_PROTOCOL_RUBIKAMassemger = 341 ,
    ...
    NDPI_PROTOCOL_RUBIKA = 346,
    NDPI_PROTOCOL_RUBIKA_MESSANGER = 347,
    NDPI_PROTOCOL_RUBIKA_RUBINO = 348,
    NDPI_PROTOCOL_RUBIKA_SERVICE = 349,
    NDPI_PROTOCOL_RUBIKA_MESSANGER_FILE = 350,
    NDPI_PROTOCOL_RUBIKA_RUBINO_FILE = 351,
